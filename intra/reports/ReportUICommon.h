...
public: 
  ...
  void form_data_transfer( void )
  {
    ...
    stringFXfer( "External_Program", External_Program);
  } 
  ...
  bool form_display( void )
  {
    ...
    if( Id )
    {
      paramLink += " &nbsp; <a target=\"reportview\" href=\"";
      paramLink +=  External_Program.length()?External_Program:"Reports.cgi";
      paramLink +=     "?Id=";
      paramLink.append(Id);
      paramLink += "\">View / Test Report</a>";
    }
    ...
    script << "<br class='clearall'>" << endl;
    script << makeTextBox("External Reporting Program", "External_Program", External_Program ,"125","35");
    script << "<br class='clearall'>" << endl; 

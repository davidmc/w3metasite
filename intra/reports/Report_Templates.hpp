...
*/  
#ifndef Report_Templates_HPP
#define Report_Templates_HPP

#include "read_write_base.hpp"

class Report_Templates_Obj: public read_write_base
{
public:
  identifier Id;
  llong Site_Id;
  ...
  Report_Templates_Obj():read_write_base()
  ,Id(0LL)
  ,Site_Id(0LL)
  ,Name("")
  ,Path("")

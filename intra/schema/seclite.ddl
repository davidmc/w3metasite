...
-- bootstrapping
insert into users (  last,  first,  login,  password, email, phone,  mobile, pager, xml_preferences  )
values
( 'McCombs', 'David', 'davidmc', 'freedom7', 'davidmc@w3sys.com', '706 581-4607', '706 581-4607', '', '' );

insert into services 
( sequence,tree_depth,enabled,cat_name,menu_name,uri,target, prog_enum )
values
( 1,1,1,'Service Authorization','Services','services_liteUI.meta?init=1','_self',0);
insert into services 
( sequence,tree_depth,enabled,cat_name,menu_name,uri,target, prog_enum )
values
( 2,1,1,'Service Authorization','Roles','rolesUI.meta?init=1','_self',0);
